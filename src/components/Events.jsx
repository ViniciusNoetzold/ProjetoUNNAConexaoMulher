...
const UNNA_EVENTS = [
  {
    ...
    dateLabel: 'Realizado em 13/05/2026',
    badge: 'REALIZADO',
    time: '19h30',
    ...
    content: [
      ...
      'O Balão Mágico recebeu essa edição especial do UNNA com palestras provocadoras, rodadas de conexão guiada e momentos que ficam.',
      'Evento realizado em 13/05/2026.',
    ],
  },
  {
    id: 'panambi',
    ...
    content: [
      ...
      'A programação terá mesas temáticas, mentoria rápida com especialistas convidadas e uma experiência pensada para fechar a noite com estilo.',
    ],
  },
  {
    id: 'palmeira',
    ...
    image: foto14,
    content: [
      'Das Missões para o mundo — Palmeira das Missões recebe o UNNA com uma visão ampliada do que é possível quando mulheres se unem.',
  ...
  },
  {
    ...
    image: foto22,
    content: [
      'Sarandi recebe sua primeira edição UNNA numa noite de pura conexão para mulheres que querem mais — mais propósito, mais rede, mais impacto.',
  ...
  },
  {
    ...
    image: foto13,
    content: [
      'A maior edição do circuito UNNA acontece em Passo Fundo, reunindo centenas de mulheres numa noite que será marco no movimento feminino gaúcho.',
