...
const UNNA_EVENTS = [
  ...
  },
  {
    ...
    image: foto13,
    content: [
      'A maior edição do circuito UNNA acontece em Passo Fundo. O Gran Marquise Hall recebe centenas de mulheres numa noite que será marco no movimento feminino gaúcho.',
